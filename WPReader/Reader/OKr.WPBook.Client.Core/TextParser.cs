...
namespace At.Okr.Client.Core
{
    public class TextParser
    {
        ...
        public static At.Okr.Client.Core.Data.Page GetOnePage(string str, int start, int[] count)
        {
            At.Okr.Client.Core.Data.Page result = new At.Okr.Client.Core.Data.Page();
            int num = 1;
            int num2 = 0;
            int num3 = 0;
            int length = 0;
        ...
        public static Chapter GetChapter(string context, int[] count)
        {
            ...
            {
                At.Okr.Client.Core.Data.Page item = GetOnePage(context, start, count);
                start += item.CharNum;
